...
// We used below annotation to bring real dependency of Customer Repository
@DataJpaTest
// This class for unit test
class CustomerServiceTest {
    ...
    // After each test we will delete everything in the database
    @AfterEach
    void tearDown() {
